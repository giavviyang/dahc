<template>
  <div class="app-container-padding">
    <el-form :model="queryParams" ref="queryForm" :inline="true" size="mini" class="iptAndBtn" @submit.native.prevent>
      ...
      <el-form-item label="状态" prop="status" @change="handleQuery">
    ...
    <TablePage class="tablePage"
      ...
      <template slot="table">
        <el-table-column
          type="index"
          label="序号"
          width="60" show-overflow-tooltip class-name="textLeft">
          <template slot-scope="scope">
             {{ scope.row.rowIndex }}
          </template>
        </el-table-column>
        <el-table-column prop="menuName" label="菜单名称" :show-overflow-tooltip="true" width="160"
                         className="textLeft"></el-table-column>
        ...
        <el-table-column prop="status" label="状态" width="100" show-overflow-tooltip class-name="noticeType">
          <template slot-scope="scope">
        ...
        <el-row>
          ...
          <el-col :span="24" v-if="form.menuType != 'F'">
            <el-form-item label="菜单图标" prop="icon">
              ...
              >
                <IconSelect ref="iconSelect" @selected="selectedName"/>
...
export default {
  ...
  components: {TablePage, Treeselect, IconSelect},
  data() {
    return {
      rowId: 'menuId',
      // 遮罩层
          ...
          this.menuList.forEach((item, index) => {
            ...
            if (item.children) {
              item.children.forEach((childItem, childIndex) => {
                childItem.rowIndex = `${item.rowIndex}.${childIndex + 1}`
                if (childItem.children) {
                  childItem.children.forEach((sonItem, sonIndex) => {
                    sonItem.rowIndex = `${item.rowIndex}.${childIndex + 1}.${sonIndex+1}`
                  })
                }
              })
            }
