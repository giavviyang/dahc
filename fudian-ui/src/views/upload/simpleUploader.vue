<template>
  ...
  <el-dialog
    ...
    <!--    <el-form ref="refFile" :rules="rules" :model="fileFrom">
        ...
        <span slot="footer" class="dialog-footer">
          <el-button
            type="primary"
            size="mini"
            @click="uploadAdd('refFile')">
            上传
          </el-button>
          <el-button

                  size="mini"
                  @click="closeSimpleUploader">
            取消
          </el-button>-->
    ...
    <Upload v-on="$listeners" v-bind="$attrs" :projectId="projectId"
            :archivesId="archivesId" :caseFileNumber="caseFileNumber" ></Upload>
    <!--    <uploader
          ref="uploader"
          :options="options"
          :autoStart=false
...
<script>
  ...
  import {readingPicturesFromAFileDirectory} from "@/api/fileData/fileData";
