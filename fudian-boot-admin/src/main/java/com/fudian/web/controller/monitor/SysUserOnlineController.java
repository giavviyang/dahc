...
import com.fudian.system.domain.SysUserOnline;
import com.fudian.system.service.ISysUserOnlineService;
...
public class SysUserOnlineController extends BaseController
{
    ...
    public TableDataInfo list(String ipaddr, String userName)
    {
        ...
        //排序
        //userOnlineList.sort((t1, t2) -> t1.getLoginTime().compareTo(t2.getLoginTime()));
